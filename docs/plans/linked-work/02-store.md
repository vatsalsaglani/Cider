...
Coordinator merge verification: restored all-workspaces contributor and retained isolated-chat projection after final rewrite, with an attach/detach regression. Native build, 11 store tests, 3 migration tests, 8 contract tests and all 95 Swift tests passed. Live application cutover remains Plan 05.
